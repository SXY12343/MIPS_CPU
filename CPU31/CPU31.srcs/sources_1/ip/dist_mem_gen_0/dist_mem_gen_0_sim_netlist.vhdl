...
-- Date        : Tue Jul 09 11:49:39 2024
-- Host        : DESKTOP-D2C712Q running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/CPU31/CPU31.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0_sim_netlist.vhdl
...
architecture STRUCTURE of dist_mem_gen_0_rom is
  ...
  attribute SOFT_HLUTNM of \spo[31]_INST_0_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \spo[5]_INST_0_i_2\ : label is "soft_lutpair2";
begin
...
begin
  ...
  spo(23) <= \<const0>\;
  spo(22) <= \<const0>\;
  spo(21 downto 14) <= \^spo\(21 downto 14);
  spo(13) <= \^spo\(15);
...
\synth_options.dist_mem_inst\: entity work.dist_mem_gen_0_dist_mem_gen_v8_0_10_synth
     port map (
      ...
      spo(18) => \^spo\(24),
      spo(17 downto 10) => \^spo\(21 downto 14),
      spo(9 downto 8) => \^spo\(12 downto 11),
      spo(7) => \^spo\(9),
      spo(6 downto 0) => \^spo\(6 downto 0)
    );
end STRUCTURE;
