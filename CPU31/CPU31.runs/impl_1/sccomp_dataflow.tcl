...
set rc [catch {
  ...
  set_property ip_repo_paths d:/CPU31/CPU31.cache/ip [current_project]
  set_property ip_output_repo d:/CPU31/CPU31.cache/ip [current_project]
  add_files -quiet D:/CPU31/CPU31.runs/synth_1/sccomp_dataflow.dcp
  add_files -quiet d:/CPU31/CPU31.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0.dcp
  set_property netlist_only true [get_files d:/CPU31/CPU31.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0.dcp]
  read_xdc -mode out_of_context -ref dist_mem_gen_0 -cells U0 d:/CPU31/CPU31.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0_ooc.xdc
  set_property processing_order EARLY [get_files d:/CPU31/CPU31.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0_ooc.xdc]
